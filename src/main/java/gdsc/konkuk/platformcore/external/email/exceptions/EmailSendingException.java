...
public class EmailSendingException extends BusinessException {
    ...
    protected EmailSendingException(CustomErrorCode errorCode, String logMessage) {
        super(errorCode, logMessage);
    }

    public static EmailSendingException of(CustomErrorCode errorCode, String logMessage) {
