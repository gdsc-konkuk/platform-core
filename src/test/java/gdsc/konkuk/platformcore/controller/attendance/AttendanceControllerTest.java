...
class AttendanceControllerTest {
                                ...
                                resource(
                                        ResourceSnippetParameters.builder()
                                                ...
                                                .responseFields(
                                                        ...
                                                        fieldWithPath(
                                                                "data[].attendanceId").description(
                                                                "출석 ID").optional(),
                                                        fieldWithPath("data[].title").description(
                                                                "출석 제목"),
                                                        fieldWithPath(
                                                                "data[].attendanceTime").description(
                                                                "출석 시간"))
                                                .build())));
    }
                                ...
                                resource(
                                        ResourceSnippetParameters.builder()
                                                ...
                                                .pathParameters(parameterWithName(
                                                        "attendanceId").description("출석 ID"))
                                                .queryParameters(
                                                        parameterWithName("qrUuid").description(
                                                                "QR 코드 UUID"))
                                                .responseHeaders(
    ...
    void should_register_attendance_when_pass_event_id() throws Exception {
        ...
        given(attendanceService.registerAttendance(registerRequest.getTitle(),
                registerRequest.getBatch()))
                                        ...
                                        ResourceSnippetParameters.builder()
                                                ...
                                                .responseFields(
                                                        ...
                                                        fieldWithPath(
                                                                "data.attendanceId").description(
                                                                "출석 ID"),
                                                        fieldWithPath("data.attendUrl").description(
                                                                "출석 URL"))
                                                .build())));
    }
                                        ...
                                        ResourceSnippetParameters.builder()
                                                ...
                                                .responseFields(
                                                        ...
                                                        fieldWithPath("data.total").description(
                                                                "전체 인원"),
                                                        fieldWithPath("data.attended").description(
                                                                "출석 인원"))
                                                .build())));
    }
